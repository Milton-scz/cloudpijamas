                        ...
                        <tbody>
                          <tr v-for="producto in productos" :key="producto.id">
                            ...
                            <td style="text-align: center;">
                                ...
                                <Link :href="route('admin.productos.edit',producto)" method="get" class="bg-yellow-500 text-white p-2 rounded" as="button"> Editar</Link>
                            <Link @success="onDeleteSuccess" :href="route('admin.productos.destroy',producto)" method="delete" class="bg-red-500 text-white p-2 rounded"  as="button"> Eliminar</Link>
