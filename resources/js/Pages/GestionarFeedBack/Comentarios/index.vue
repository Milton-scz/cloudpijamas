...
import { ref } from 'vue';
const page = usePage();
const comentarios = ref(page.props.comentarios);
const onDeleteSuccess = (e) => {
    console.log(e);
    comentarios.value = e.props.comentarios;
}
</script>
            ...
            <section id="contenido_principal">
              <div class="col-md-12" style="margin-top: 10px;">
                <div class="box box-default" style="border: 1px solid #574B90; min-height: 35px;">
                    <Link  :href="route('admin.comentarios.create')" method="get" as="button"> Crear Comentario</Link>
                </div>
              </div>
                      ...
                      <table class="table table-bordered table-condensed table-striped" style="width: 100%;">
                        ...
                        <tbody>
                          <tr v-for="comentario in comentarios" :key="comentario.id">
                            ...
                            <td style="text-align: center;">{{ comentario.user.name }}</td>
                            <td style="text-align: center;">{{ comentario.descripcion }}</td>
                            <td style="text-align: center;">



                            <Link @success="onDeleteSuccess" :href="route('admin.comentarios.destroy',comentario)" method="delete" class="bg-red-500 text-white p-2 rounded"  as="button"> Eliminar</Link>
